...
from pooling_layers.LastLayersTrainablePooling import PerceiverResampler
...
def main():
    ...
    class MistralForSequenceEmbedding(torch.nn.Module):
        def __init__(self,model_name_or_path):
            ...
            self.model = MistralBiModel.from_pretrained(model_name_or_path, 
                                                   cache_dir = cache_dir,
            ...
            self.max_length = model_args.max_seq_length
        ...
        def forward(
            ...
            embeddings = self.attn_pool(hidden_states)
    ...
    #         self.model.save(output_dir)
            ...
            torch.save(self.model.attn_pool.state_dict(),output_dir+"attn_pool.pt")
